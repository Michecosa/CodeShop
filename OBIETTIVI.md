...
- [x] **Dashboard Amministrativa (CRUD)**: Sviluppare un'interfaccia di backoffice dedicata per la gestione completa del catalogo, permettendo l'aggiunta, la modifica e la rimozione dei prodotti.
